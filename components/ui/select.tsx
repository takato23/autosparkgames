...
const SelectTrigger = React.forwardRef<
  ...
  SelectTriggerProps
>(({ className, children, status = 'default', helperTextId, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-lg border bg-background px-3 py-2 text-sm ring-offset-background",
      status === 'error' ? 'border-destructive focus:ring-destructive' : status === 'success' ? 'border-emerald-500 focus:ring-emerald-500' : 'border-input',
